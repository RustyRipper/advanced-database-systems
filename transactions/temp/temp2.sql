CREATE INDEX idx_reservation_parking_spot_id ON Reservation(parking_spot_id);
...
-- Plan wykonania po utworzeniu indeksów
EXPLAIN PLAN FOR
SELECT cc.brand,
       cc.color,
...
DROP TABLE ClientCar;
DROP TABLE ParkingUser;
